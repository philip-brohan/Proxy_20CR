...
#  for the 20CR2c fields

# Based on the TF tutorial at:
#   https://www.tensorflow.org/tutorials/generative/cvae

# This version fits a set of 3 fields, P, U and V.
...
def compute_loss(model, x):
    ...
    return (rmse_p, rmse_u, rmse_v, logpz, logqz_x)
...
#        metric = tf.reduce_mean(rmse_p + rmse_u + rmse_v - logpz + logqz_x)
        metric = tf.reduce_mean(rmse_p + rmse_u + rmse_v - logpz + logqz_x)
