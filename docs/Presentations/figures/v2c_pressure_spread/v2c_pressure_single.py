...
# Plot an example pressure plot from v2c
# Single contour ensemble member 1 only
...
parser.add_argument(
    ...
    default="%s/Proxy_20CR/images/v2c/single" % os.getenv("SCRATCH"),
    type=str,
    required=False,
)
...
CS=ax.contour(lons, lats, prmsl.data*0.01*-1,
                           colors='blue',
                           linewidths=1.0,
                           alpha=1.0,
