...
bg = ERA5_load_T2m(obs_year + 1, obs_month, obs_day)
bg = bg - c
bg = ERA5_roll_longitude(bg)
bg = ERA5_trim(bg)
bg.coord("latitude").coord_system = cs
bg.coord("longitude").coord_system = cs
